...
<div class="right_col" role="main">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_content">
									<br />
									<c:url value="/supplier/list/1" var="searchUrl"></c:url>
	...
	<div class="table-responsive">
		<a href='<c:url value="/supplier/add"></c:url>'><button class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>Thêm</button></a>
		<!-- 
                        ...
                        <tbody>
                          <c:forEach items="${list}" var="item" varStatus="i"> 
                            ...
                            <td colspan="3" class="last text-center">
	                            ...
	                            <a href='<c:url value="/supplier/view/${item.id}"></c:url>' class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i></a> 
	                            <a href='<c:url value="/supplier/edit/${item.id}"></c:url>' class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i></a> 
...
<script type="text/javascript">
	function gotoPage(page){
		$("#searchForm").attr('action',"<c:url value='/supplier/list/'/>"+page);
		$("#searchForm").submit();
	}
	function deleteItem(id){
		if(confirm("Bạn có chắc chắn xóa nó không ?")){
			location.href="<c:url value='/supplier/delete/'/>"+id;
		}
	}
