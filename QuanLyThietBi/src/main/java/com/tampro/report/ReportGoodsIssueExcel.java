...
public class ReportGoodsIssueExcel extends AbstractXlsView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		row.createCell(7).setCellValue("Khách hàng");
		...
		if(!list.isEmpty()) {
			...
			for(InvoiceDTO invoiceDTO : list) {
				...
				rowContent.createCell(7).setCellValue(invoiceDTO.getCusName());
